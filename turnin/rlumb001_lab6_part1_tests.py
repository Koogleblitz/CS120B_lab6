...
tests = [ 
    ...
    {
        'description': 'trying out time.',
        'steps': 
            [ 
                
                {'inputs': [('PINA', 0)],'iterations': 1, 'expected': [('PORTB',1)]}, # Set PIN to val then run one iteration
                {'inputs': [('PINA',0)], 'time': 300, 'expected': [('PORTB',1)]},
                {'inputs': [('PINA',0)], 'iterations': 1, 'expected': [('PORTB',1)]},
                {'inputs': [('PINA',0)], 'time': 601, 'expected': [('PORTB',2)]},
                {'inputs': [('PINA',0)], 'iterations': 1, 'expected': [('PORTB',2)]},  
